...
# MAGIC 1. [Extract-Tranform-Load (ETL) of source data](https://adb-984752964297111.11.azuredatabricks.net/?o=984752964297111#notebook/450110666116507/command/450110666116508)
# MAGIC 2. [Exploring, Analysing & Visualising Data](https://adb-984752964297111.11.azuredatabricks.net/?o=984752964297111#notebook/450110666116533/command/450110666116534)
# MAGIC 3. [Machine Learning Model Development with MLFlow](https://adb-984752964297111.11.azuredatabricks.net/?o=984752964297111#notebook/450110666116560/command/450110666116561)
# MAGIC 
# MAGIC *Notebooks are adjusted for demo by zachary.davies@databricks.com*  
...
# MAGIC %md
# MAGIC [Next Notebook - Data Preparation]($./01 - Insurance Data Preparation)
